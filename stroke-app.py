...
def main():
    # new_title = '<p style="font-family:sans-serif; color:Red; font-size: 42px;">Stroke Prediction</p>'
    ...
    hypertension = st.sidebar.selectbox('Hypertensize',('Yes', 'No'))
    ...
    # create dataframe with features and use original colun names 
